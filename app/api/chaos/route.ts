...
export async function GET() {
  return NextResponse.json({
    ...
    endpoints: {
      ...
      '/api/chaos/n-body': {
        description: 'Simulate N-body gravitational system',
        method: 'GET',
        parameters: {
          n: { type: 'number', default: 5, min: 2, max: 20, description: 'Number of bodies' },
          duration: { type: 'number', default: 20, max: 50, description: 'Simulation duration' },
          dt: { type: 'number', default: 0.001, description: 'Time step' },
          G: { type: 'number', default: 1, description: 'Gravitational constant' },
          preset: { type: 'string', default: 'random', options: ['random', 'circular', 'collision'], description: 'Initial configuration' },
        },
        example: '/api/chaos/n-body?n=7&preset=circular&duration=20',
      },
      '/api/chaos/boids': {
        description: 'Simulate flocking behavior (Reynolds boids algorithm)',
        method: 'GET',
        parameters: {
          n: { type: 'number', default: 50, min: 2, max: 200, description: 'Number of boids' },
          duration: { type: 'number', default: 20, max: 30, description: 'Simulation duration' },
          dt: { type: 'number', default: 0.05, description: 'Time step' },
          separation: { type: 'number', default: 1.5, description: 'Separation weight' },
          alignment: { type: 'number', default: 1.0, description: 'Alignment weight' },
          cohesion: { type: 'number', default: 1.0, description: 'Cohesion weight' },
        },
        example: '/api/chaos/boids?n=80&separation=1.5&alignment=1.0&cohesion=1.0',
      },
      '/api/chaos/henon': {
        description: 'Generate Hénon attractor trajectories',
        method: 'GET',
        parameters: {
          a: { type: 'number', default: 1.4, description: 'Parameter a' },
          b: { type: 'number', default: 0.3, description: 'Parameter b' },
          x0: { type: 'number', default: 0, description: 'Initial x' },
          y0: { type: 'number', default: 0, description: 'Initial y' },
          iterations: { type: 'number', default: 10000, max: 50000, description: 'Number of iterations' },
        },
        example: '/api/chaos/henon?a=1.4&b=0.3&iterations=10000',
      },
      '/api/chaos/duffing': {
        description: 'Simulate Duffing oscillator',
        method: 'GET',
        parameters: {
          alpha: { type: 'number', default: -1, description: 'Linear stiffness' },
          beta: { type: 'number', default: 1, description: 'Nonlinear stiffness' },
          delta: { type: 'number', default: 0.2, description: 'Damping' },
          gamma: { type: 'number', default: 0.3, description: 'Forcing amplitude' },
          omega: { type: 'number', default: 1.2, description: 'Forcing frequency' },
          duration: { type: 'number', default: 100, description: 'Simulation duration' },
          dt: { type: 'number', default: 0.01, description: 'Time step' },
        },
        example: '/api/chaos/duffing?alpha=-1&beta=1&gamma=0.3&duration=100',
      },
    },
    usage: {
